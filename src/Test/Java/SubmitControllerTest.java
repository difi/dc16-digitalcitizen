...
public class SubmitControllerTest extends AbstractControllerTest {
    ...
    public void testSubmit() throws Exception {
        ...
        Submission submission = new Submission(true, new Person("01108019146", "Eldar Eldarsen", new Address("Trondheim", "NO", "Trondheim", "testveien 1", "7030"), "99999990", "test@test.no", new Doctor("Tore", "Trondheim")), dependents, "lenge", "ingen", "Ingen", "ingen");
