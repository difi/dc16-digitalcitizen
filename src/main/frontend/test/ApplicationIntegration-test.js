...
describe("Application", () => {
    ...
    it("Third page forwards you to correct step", () => {
        ...
        thirdPage.find('input[type="checkbox"]').simulate('click');
        thirdPage.find(FormControl).last().simulate('change', {target: {value: 'Snorre'}});
   ...
   /* it("fourth page forwards you to correct step", () => {
        ...
        fourthPage.find(FormControl).first().simulate('change', {target: {value: '26024003298'}});
        fourtPage.find(FormControl).last().simulate('change', {target: {value: 'Snorre'}});
        var nextButton = subject.find(NavigationButtons).find('.next-btn');
        nextButton.simulate('click');
